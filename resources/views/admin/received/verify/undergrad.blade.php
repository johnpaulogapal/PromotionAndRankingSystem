<x-admin.layout>
    ...
    <div class="pt-24 p-10 h-screen w-full grid place-items-center content-start gap-8">
        <p class="font-bold uppercase text-center text-xl tracking-widest mb-2">
            Undergrad Information of {{$undergrad->user->first_name . " " . $undergrad->user->last_name}}
        </p>
        ...
        <div class="border-t border-hau flex justify-end pt-5 gap-x-12">
            <a href="{{route('received.show', $undergrad->user_id)}}" class="py-1.5 px-4 text-xl text-white tracking-widest bg-gray-500 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-gray-600 duration-300">
                <i class="fa-solid fa-arrow-left mr-1"></i>Back
            </a>

            @if($undergrad->status == 'processing')
            ...
            <button 
                ...
                data-te-target="#resubmitUndergradModal"
                data-te-ripple-init
            ...
            <button 
                ...
                data-te-toggle="modal"
                data-te-target="#checkedUndergradModal"
                data-te-ripple-init
                data-te-ripple-color="light">
            ...
            aria-hidden="true">
                ...
                class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                    <div
                        ...
                        <form method="POST" action="{{route('verify.approved.undergrad', $undergrad->id)}}">
                        @csrf
                        @method('PUT')
            ...
            aria-hidden="true">
                ...
                class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                    <div
                        ...
                        <form method="POST" action="{{route('verify.resubmit.undergrad', $undergrad->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="relative flex-auto p-4" data-te-modal-body-ref>
