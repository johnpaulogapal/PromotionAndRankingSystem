<x-admin.layout>
    ...
    <div class="pt-24 p-10 h-screen w-full grid place-items-center content-start gap-8">
        ...
        <div class="border-t border-hau flex justify-end pt-5 gap-x-12">
            <a href="{{route('received.show', $master->user_id)}}" class="py-1.5 px-4 text-xl text-white tracking-widest bg-gray-500 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-gray-600 duration-300">
            ...
            <button 
                ...
                data-te-target="#resubmitMasterModal"
                data-te-ripple-init
            ...
            <button 
                ...
                data-te-toggle="modal"
                data-te-target="#checkedMasterModal"
                data-te-ripple-init
                data-te-ripple-color="light">
            ...
            aria-hidden="true">
                ...
                class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                    <div
                        ...
                        <form method="POST" action="{{route('verify.approved.master', $master->id)}}">
                        @csrf
                        @method('PUT')
            ...
            aria-hidden="true">
                ...
                class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                    <div
                        ...
                        <form method="POST" action="{{route('verify.resubmit.master', $master->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="relative flex-auto p-4" data-te-modal-body-ref>
