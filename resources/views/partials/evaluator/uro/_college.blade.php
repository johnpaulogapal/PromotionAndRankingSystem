<div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
    <h3 class="font-bold uppercase text-center text-3xl">Faculty - College</h3>
    ...
    @method('PUT')
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-neutral-500">
                ...
                <td class="whitespace-nowrap px-6 py-4">
                    @if(empty($user->score->research))
                        <div class="flex flex-col justify-center gap-1">
                            ...
                            <input name="research" type="number" class="w-1/4 py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('research')}}" min="1" max="25" required>
                            @error('research')
                ...
                <td>
                    @if(empty($user->score->research_min))
                        <div class="flex gap-x-4">
                            <div class="mx-5">
                                <input name="research_min" type="radio" value=2 class="py-1.5 px-1.5 border border-hau rounded-full appearance-none checked:bg-green-500 checked:border-green-500" required>
                                <label for="" class="text-hau tracking-wider">Met</label>
                            </div>   
                            <div class="">
                                <input name="research_min" type="radio" value=1 class="py-1.5 px-1.5 border border-hau rounded-full appearance-none checked:bg-green-500 checked:border-green-500">
