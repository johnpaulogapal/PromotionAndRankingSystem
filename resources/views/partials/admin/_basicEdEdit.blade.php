            ...
            <tbody>
              ...
              <tr class="border-b dark:border-neutral-500">
                ...
                <td class="whitespace-nowrap px-6 py-4">
                    ...
                    <div class="flex flex-col justify-center gap-1">
                        <label for="" class="font-bold text-hau text-sm tracking-wider"></label>
                        <input name="prof_exam" type="number" class="w-1/4 py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{$user->score->prof_exam}}" min="60" max="100" required>
                        @error('prof_exam')
                            <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                        @enderror
                    </div>
                ...
                class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                    ...
                    class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none">
                        ...
                        <div class="relative flex-auto p-4" data-te-modal-body-ref>
                            <p class="font-bold uppercase tracking-widest">Are you sure you want to update the score?</p>
                        </div>
                        <div
