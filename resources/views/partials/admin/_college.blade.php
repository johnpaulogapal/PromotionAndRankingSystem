              ...
              <tr class="border-b dark:border-neutral-500">
                ...
                <td>
                    @if(empty($user->score))
                        <div class="flex gap-x-4">
                            <div class="mx-5">
                                <input name="research" type="radio" value=1 class="py-1.5 px-1.5 border border-hau rounded-full appearance-none checked:bg-green-500 checked:border-green-500" required>
                                <label for="" class="text-hau tracking-wider">Met</label>
                            </div>   
                            <div class="">
                                <input name="research" type="radio" value=0 class="py-1.5 px-1.5 border border-hau rounded-full appearance-none checked:bg-green-500 checked:border-green-500">
                                <label for="" class="text-hau tracking-wider">Not</label>
                            </div>
                            @error('research')
                                <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                    ...
                    @else
                        <span class="font-bold mx-5">{{$user->score->research == 1 ? 'Met' : 'Not'}}</span>
                    @endif
                </td>
              </tr>
              <tr class="border-b dark:border-neutral-500">
