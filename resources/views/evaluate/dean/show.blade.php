<x-evaluator.layout>
    ...
    <div class="w-full pt-24 p-24 space-y-8">   
        ...
        <a href="/dean" class="py-1 px-2 text-white tracking-widest bg-gray-700 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-gray-600 duration-300">
        ...
        <div class="w-full p-12 border-t-8 border-hau rounded shadow-2xl">
            ...
            <h2 class="w-full mb-5 font-bold uppercase text-lg text-center tracking-widest">{{$user->user_type == 'basicEd' ? 'Basic Education' : 'College'}} Faculty</h2>
            @if($user->user_type == 'basicEd')
                @include('partials.admin.score._basicEdscore')
            @else
