                ...
                <tbody class="bg-white">
                    ...
                    <tr class="whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 font-bold text-center tracking-widest">
                            ...
                            <a href="{{route('oces.show', $approvedApplication->user_id)}}" class="p-1 text-white tracking-widest bg-cyan-600 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-cyan-700 duration-300">
                                Evaluate
                            </a>
