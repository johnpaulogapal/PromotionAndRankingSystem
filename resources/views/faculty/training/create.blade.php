                ...
                <div class="w-3/4 py-5 px-10 border-t-4 border-hau rounded-b shadow-2xl">
                    <div class="grid grid-cols-3 gap-8">
                        ...
                        <div class="flex flex-col justify-start">
                            ...
                            <input name="from" type="date" class="py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('from')}}">
                            @error('from')
                        ...
                        <div class=" flex flex-col justify-start">
                            ...
                            <input name="to" type="date" class="py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('to')}}">
                            @error('to')
                                <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-start-1 flex flex-col justify-start">
                            ...
                            <input name="title" type="text" class="py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('title')}}">
                            @error('title')
                                <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="flex flex-col justify-start">
                            ...
                            <input name="speaker" type="text" class="py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('speaker')}}">
                            @error('speaker')
                                <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="flex flex-col justify-start">
                            ...
                            <input name="venue" type="text" class="py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('venue')}}">
                            @error('venue')
                                <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="flex flex-col justify-start">
                            ...
                            <input name="institution" type="text" class="py-0.5 px-2 border border-hau rounded caret-hau outline-hau" value="{{old('institution')}}">
                            @error('institution')
                                <p class="font-bold text-red-500 mt-1">{{$message}}</p>
                            @enderror
                        </div>
