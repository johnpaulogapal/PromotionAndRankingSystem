        ...
        <section>
            ...
            @csrf
                ...
                <div class="mt-12 flex justify-center gap-x-4">
                    <a href="{{route('profile.show', auth()->user()->id)}}" class="py-1.5 px-4 text-xl text-white tracking-widest bg-red-600 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-red-700 duration-300">
