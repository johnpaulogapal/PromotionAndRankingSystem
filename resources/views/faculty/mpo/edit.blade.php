<x-faculty.layout>
    <x-faculty.navigation>
        ...
        <section class="h-screen w-full p-8">
            ...
            <form method="POST" action="{{route('mpo.update', $mpo->id)}}" class="pt-5 grid justify-items-center content-start gap-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="mt-5 flex justify-center gap-x-4">
                    <a href="{{route('mpo.index')}}" class="py-1.5 px-4 text-xl text-white tracking-widest bg-gray-400 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-gray-500 duration-300">
