    ...
    <x-faculty.navigation>
        ...
        <section class="h-screen w-full p-8">
            <div class="flex flex-col jusfity-center items-center gap-y-4">
                <p class="uppercase text-xl text-center tracking-widest">PRC License Information</p>
                    ...
                    <div class="w-1/2 p-5 border-t-4 border-hau grid grid-cols-2 gap-4 rounded-b shadow-2xl">
                        ...
                        <div class="grid grid-rows-3 gap-y-4">
                            ...
                            <div class="pt-5 justify-self-end">
                                <a href="{{route('prc.edit', $prc->id)}}" class="py-1 px-2 text-white tracking-widest bg-yellow-500 rounded shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-yellow-600 duration-300">
